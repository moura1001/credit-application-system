...
import moura1001.creditapplicationsystem.dto.CustomerView.CustomerView
...
class CustomerController(
    ...
    fun saveCustomer(@RequestBody customerDto: CustomerDto) : ResponseEntity<String> {
        ...
        return ResponseEntity.created(URI.create("")).body("customer ${savedCustomer.email} successfully saved")
    }
    ...
    fun updateCustomer(@RequestParam(value = "customerId") id: Long,
                       @RequestBody customerDto: CustomerUpdateDto) : ResponseEntity<CustomerView> {
        val customer = this.customerService.findById(id)
